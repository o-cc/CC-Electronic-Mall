...
<body>
    ...
    <div class="juli">
       ...
       <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
           ...
           DataKeyNames="id">
            ...
            <Columns>
                <asp:BoundField DataField="id" HeaderText="商品号" />
    ...
    <div>
       <div>
        <input class="coco" id="chkConfirm" runat="server"  type="checkbox" name="checkbox1" 
            value=" 是否已确认" enableviewstate="True" />是否已支付
            <a href="#" class="ococ" style="display:none;">未支付点我</a>
    </div>
       <div>
        <input type="checkbox" runat="server" id="chkConsignment" name="checkbox2" value=" 是否已发货" />是否已收货
    </div>
        <div class="btn-par">
